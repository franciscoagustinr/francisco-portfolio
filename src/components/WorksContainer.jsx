    ...
    <>
      {Works &&
        Works.map((work) => {
          ...
          return (
            <div key={work.id} className="group relative mb-4">
              <a
                href={work.url}
                target="_blank"
              ...
              >
                ...
                <div className="flex flex-row no-wrap justify-start items-center gap-2 p-2 text-left border-b border-[#292929] transition-all ease-in-out duration-300">
                  ...
                  <div className=" -translate-x-9 group-hover:-translate-x-0 transition-all duration-[210ms] ease-linear">
                    <h2 className="font-Karla text-lg text-[#6D696A] z-50 transition-all duration-200 ease-linear">
                      {work.name}
                    </h2>
