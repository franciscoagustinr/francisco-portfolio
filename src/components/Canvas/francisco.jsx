...
export const Francisco = ({ props, setDialogText }) => {
  ...
  const playHoverSound = () => {
    const sound = new Howl({
      src: ['assets/sounds/bubble-pop-avatar.mp3'],
      volume: 0.05,
    });
    sound.play();
  };
        ...
        if (child.isMesh) {
          ...
          if (material) {
            ...
            if (isErrorPage) {
              ...
              setTimeout(() => {
                setDialogText(
                  "Welcome! <img src='../src/assets/images/sparkles.png' class='inline-block w-6'/><img src='../src/assets/images/slightly-smiling-face.png' class='inline-block w-6'/> "
                );
                influences[0] = 1;
                influences[1] = 1;
