    ...
    >
      ...
      >
        ...
        <img
          ...
          alt="Francisco"
          className="relative -top-[5.5rem] left-2 !w-24 select-none opacity-0 transition-all duration-300 ease-in-out group-hover:scale-125 group-hover:opacity-100 md:-top-[5.5rem] md:left-2 4xl:-top-[15rem] 4xl:left-8 4xl:!w-72"
        />
      </div>
    </div>
  );
